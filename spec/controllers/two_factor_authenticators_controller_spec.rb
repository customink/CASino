...
describe CASino::TwoFactorAuthenticatorsController do
  describe 'GET "new"' do
    it 'calls the process method of the TwoFactorAuthenticatorRegistrator' do
      CASino::Processors::TwoFactorAuthenticatorRegistrator.any_instance.should_receive(:process)
      get :new
    end
  end
  ...
  describe 'POST "create"' do
    it 'calls the process method of the TwoFactorAuthenticatorActivator' do
      CASino::Processors::TwoFactorAuthenticatorActivator.any_instance.should_receive(:process) do
  ...
  describe 'DELETE "destroy"' do
    ...
    it 'calls the process method of the TwoFactorAuthenticatorDestroyer processor' do
      ...
      CASino::Processors::TwoFactorAuthenticatorDestroyer.any_instance.should_receive(:process) do |params, cookies, user_agent|
        params[:id].should == id
