...
module CASino
  class LoginCredentialAcceptorProcessor < AbstractProcessor
    include ProcessorConcerns::LoginTickets
    include ProcessorConcerns::ServiceTickets
    include ProcessorConcerns::Authentication
    ...
    #   See {CASino::Processors::LoginCredentialRequestor} for details.
    ...
    def user_logged_in(authentication_result)
      ...
      if ticket_granting_ticket.awaiting_two_factor_authentication?
        ...
        rescue CASino::ServiceNotAllowedError => e
